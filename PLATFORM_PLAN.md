...
- **Live-verified voice Q&A, AI grading, extraction, reasoning classification, and exam coaching** — all five Claude-dependent code paths confirmed correct (identical, expected credit-balance error every time), but none has returned a real result yet - blocked entirely on Anthropic account credit top-up
