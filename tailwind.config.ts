...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      // A single reusable "that's wrong, try again" cue - kept minimal (one
      // small horizontal wobble, not a violent shake) since this plays on a
      // wrong-answer tap a child might see repeatedly in one sitting.
      keyframes: {
        shake: {
